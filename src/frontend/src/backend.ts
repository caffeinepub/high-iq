...
import type { IQTestScoreReport as _IQTestScoreReport, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addQuestion(arg0: number, arg1: string, arg2: Array<Answer>, arg3: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async calculateIQScore(arg0: Array<SessionAttempt>, arg1: bigint): Promise<IQTestScoreReport> {
        if (this.processError) {
            try {
                const result = await this.actor.calculateIQScore(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCachedScore(arg0: Principal): Promise<IQTestScoreReport | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCachedScore(arg0);
    ...
    async getQuestionsInRange(arg0: number, arg1: number): Promise<Array<QuestionDTO>> {
        if (this.processError) {
            try {
                const result = await this.actor.getQuestionsInRange(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecommendedQuestions(arg0: number, arg1: number, arg2: bigint): Promise<Array<QuestionDTO>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecommendedQuestions(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchByText(arg0: string): Promise<Array<QuestionDTO>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchByText(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitAnswer(arg0: string, arg1: bigint, arg2: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async updateQuestion(arg0: string, arg1: number, arg2: string, arg3: Array<Answer>, arg4: string): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_IQTestScoreReport]): IQTestScoreReport | null {
